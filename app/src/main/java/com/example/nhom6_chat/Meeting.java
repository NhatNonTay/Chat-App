...
public class Meeting extends AppCompatActivity {
    ...
    void startMeeting(String meetingID,String name){
        sharedPreferences.edit().putString("name", name).apply();//Lưu tên người dùng vào SharedPreferences
        String userID = UUID.randomUUID().toString(); //Tạo một userID ngẫu nhiên

        Intent intent = new Intent(Meeting.this, ConferenceActivity.class);
